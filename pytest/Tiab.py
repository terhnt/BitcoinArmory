...
class TiabSession:
   ...
   # returns the port the first unobtaniumd is running on
   # In future versions of this class, multiple unobtaniumds will get different ports,
   ...
   def callBitcoinD(self, unobtaniumDArgs):
      unobtaniumDArgsCopy = copy.copy(unobtaniumDArgs)
      unobtaniumDArgsCopy.insert(0, "unobtaniumd")
      return self.processes.append(subprocess.Popen(unobtaniumDArgsCopy))
