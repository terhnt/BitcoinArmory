...
def getReleaseParams(doTest=False):
   ...
   rparams['GitEmail']       = 'contact@bxtcoinarmory.com'

   if not doTest:
      rparams['SignAddr']       = '1NWvhByxfTXPYNT4zMBmEY3VL8QJQtQoei'
      rparams['AnnounceFile']   = 'announce.txt'
      rparams['BucketAnnounce'] = 'https://s3.amazonaws.com/bxtcoinarmory-media/'
      rparams['BucketReleases'] = 'https://s3.amazonaws.com/bxtcoinarmory-releases/'
      ...
      rparams['BucketAnnounce'] = 'https://s3.amazonaws.com/bxtcoinarmory-testing/'
      rparams['BucketReleases'] = 'https://s3.amazonaws.com/bxtcoinarmory-testing/'
