...
VIAddVersionKey ProductName "Unobtanium Armory"
...
Section -Main SEC0000
    ...
    ${If} ${RunningX64}
        ...
        SetOutPath $DESKTOP
        CreateShortcut "$DESKTOP\Unobtanium Armory.lnk" $INSTDIR\ArmoryQt.exe
        !insertmacro CREATE_SMGROUP_SHORTCUT "Unobtanium Armory" "$INSTDIR\ArmoryQt.exe" ""
        !insertmacro CREATE_SMGROUP_SHORTCUT "Unobtanium Armory (Offline)" "$INSTDIR\ArmoryQt.exe" "--offline"
        !insertmacro CREATE_SMGROUP_SHORTCUT "Unobtanium Armory (testnet)" "$INSTDIR\ArmoryQt.exe" "--testnet"
...
Section /o -un.Main UNSEC0000
    !insertmacro DELETE_SMGROUP_SHORTCUT "Unobtanium Armory (testnet)"
    !insertmacro DELETE_SMGROUP_SHORTCUT "Unobtanium Armory (Offline)"
    !insertmacro DELETE_SMGROUP_SHORTCUT "Unobtanium Armory"
    Delete /REBOOTOK "$DESKTOP\Unobtanium Armory.lnk"
